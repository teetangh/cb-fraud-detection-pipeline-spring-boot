package com.fraud.enrichment.config;
...
public class CouchbaseConfig {
    ...
    /**
     * Holds both {@code profile::{customerId}} documents and the
     * {@code counter::txn::{customerId}} binary counters (ADR-0015), plus the
     * seeded {@code mcc::{code}} risk table.
     */
    @Bean("customerProfilesCollection")
    public Collection customerProfilesCollection(Bucket bucket) {
        return bucket.scope("intelligence").collection("customer-profiles");
    }
}
