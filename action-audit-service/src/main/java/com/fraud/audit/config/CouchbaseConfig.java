package com.fraud.audit.config;
...
public class CouchbaseConfig {
    ...
    @Bean("auditLedgerCollection")
    public com.couchbase.client.java.Collection auditLedgerCollection(Bucket bucket) {
        return bucket.scope("audit").collection("audit-ledger");
    }

    @Bean("casesCollection")
    public com.couchbase.client.java.Collection casesCollection(Bucket bucket) {
        return bucket.scope("audit").collection("cases");
    }
}
